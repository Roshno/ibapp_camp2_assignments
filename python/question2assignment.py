...
class Student_details:
    ...
    def create():
        ...
        if Student_details.students.get(rollno):
            ...
            Student_details.students[rollno] = student
    ...
    def delete():
        rollno = report.get_Int('Rollno: ')
        if Student_details.students.get(rollno):
            del Student_details.students[rollno]
    ...
    def modify():
        rollno = report.get_Int('Rollno: ')
        if Student_details.students.get(rollno):
            student = Student_details.students.get(rollno)
            student.display()
            while(True):
...
Choose Mark to edit:
    ...
    @staticmethod
    def listAllStudents():
        if len(Student_details.students) > 0:
            print('Student details: ')
            for rollno, student in Student_details.students.items():
                print('\nRollno: ', rollno)
                student.display()
        else:
            print('No records')
    ...
    def showStudent():
        ...
        if Student_details.students.get(rollno):
            print('\nRollno: ', rollno)
            Student_details.students[rollno].display()
        else:
            print('Student does not exist')
...
while(True):
    ...
    match opt:
        case 1: Student_details.create()
        case 2: Student_details.delete()
        case 3: Student_details.modify()
        case 4: Student_details.listAllStudents()
        case 5: Student_details.showStudent()
        case 6: break
        case _: print('Invalid input')